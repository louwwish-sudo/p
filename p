...
do
    ...
    do
        local WeatherEvent           = ReplicatedStorage.Shared.Packages.Network:FindFirstChild("rev_WeatherUpdate") or
            ReplicatedStorage.Shared.Packages.Network:FindFirstChild("rev_AddedWeather")
        ...
        local WEATHER_EVENTS         = {
            { Title = "UFO Event",     value = "UFO" },
            { Title = "Witch Event",   value = "WITCH" },
